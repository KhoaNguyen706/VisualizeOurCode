    ...
    <div className="flex flex-col gap-3 mb-4">
      <AnimatePresence mode="wait">
        <motion.div
          ...
          style={{ background: "var(--mac-sidebar)" }}
        >
          <div className="flex items-center justify-between gap-2 mb-1.5">
            <div className="text-[10px] uppercase tracking-wider text-[var(--mac-text-2)]">Explanation</div>
            {warning && (
              <span
                className="text-[10px] font-code px-2 py-0.5 rounded-sm shrink-0"
                style={{ background: "#3a3a1e", color: "var(--mac-warn)", border: "1px solid #5a5a2e" }}
              >
                Approximate
              </span>
            )}
